...
class StoryMenuState extends MusicBeatState
{
	...
	static function weekData():Array<Dynamic>
	{
		return [
			['Tutorial'],
			['Donut', 'Galactic', 'Cutscene', 'Headache']
		];
	}
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			new FlxTimer().start(1, function(tmr:FlxTimer)
			{
				...
				{
					case 'donut':
						LoadingState.loadAndSwitchState(new VideoState("assets/videos/cass/manicVid1.webm", new PlayState()));
					default:
	...
	function updateText()
	{
		...
		if (curWeek == 1)
		{
			stringThing = ['Donut', 'Galactic', 'Headache'];
		}
		else
		{
